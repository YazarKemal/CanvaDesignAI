...
def as_few_shot_block(style_id: str) -> str:
    ...
    return (
        ...
        f"background composition (Canva Stock Library search query), "
        f"native typography precision (Canva built-in fonts, vertical stack, "
        f"HEX palette), native vector elements (pill buttons, badges, frames), "
