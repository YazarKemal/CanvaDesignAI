...
def _valid_card() -> dict:
    return {
        ...
        "hero_asset": {
            "description": "Coffee shop interior photo",
        ...
        "text_blocks": [
            {"role": "headline", "content": "CLI Test", "zone": "top 30%", "relative_scale": 1.0},
            {"role": "subtext", "content": "Generated by CLI.", "zone": "below headline", "relative_scale": 0.25},
        ],
